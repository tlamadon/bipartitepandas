...
class BipartiteDataFrame():
    ...
    Arguments:
        ...
        custom_dtype_dict (dict of str): for new columns, optionally link general column names to the datatype for that set of columns (e.g. 'y' is income, links to columns 'y1' and 'y2' and should be float; then set {'y': 'float'}); must be one of 'int', 'float', 'any', or 'contig'
